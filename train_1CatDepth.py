# ════════════════════════════════════════════════════════════════
# SEGMENTATION + DIAMETER REGRESSION TRAINING SCRIPT
# ────────────────────────────────────────────────────────────────
# This extends Mask R-CNN with an extra regression head for 'diameter'.
# ════════════════════════════════════════════════════════════════
...
train_json = "/content/drive/MyDrive/RGB-D_diameter_thesis/data/apple_1c_train-dataset_coco.json"
val_json = "/content/drive/MyDrive/RGB-D_diameter_thesis/data/apple_1c_val-dataset_coco.json"
image_train_dir = "/content/drive/MyDrive/RGB-D_diameter_thesis/data/images/train"
image_val_dir = "/content/drive/MyDrive/RGB-D_diameter_thesis/data/images/val"
output_dir = "/content/drive/MyDrive/RGB-D_diameter_thesis/output_diameter_1c"
...
class CustomROIHeads(StandardROIHeads):
    ...
    def __init__(self, cfg, input_shape):
        ...
        self.diameter_pred = torch.nn.Linear(in_features, 1)
    ...
    def _forward_box(self, features, proposals):
        ...
        if self.training:
            ...
            diam_pred = self.diameter_pred(box_features).view(-1)
        ...
        if hasattr(data["instances"], "gt_classes") and len(diameters) > 0:
            ...
            if depth_path is None:
                ...
                depth_path = os.path.join(
                    "/content/drive/MyDrive/RGB-D_diameter_thesis/data/depthCropNpy", filename
                )
            if depth_path is None:
